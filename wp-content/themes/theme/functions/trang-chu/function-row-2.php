<?php
function create_homepage_row_2_type() {
$homepageRow2labels = array (
//BEGIN - Việt Hóa menu custom post type
'name' => _x('Homepage row 2','Homepage row 2'),
'singular_name' => _x('Homepage row 2','Homepage row 2'),
'add_new' => __ ('Thêm row'),
...
'menu_name' => 'Homepage row 2'
//END - Việt hóa menu custom post type
);
$args = array(
'labels' => $homepageRow2labels,
...
// die;
register_post_type ('homepage_row_2',$args);
}
add_action ('init','create_homepage_row_2_type');
?>