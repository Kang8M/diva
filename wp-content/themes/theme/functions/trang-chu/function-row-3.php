<?php
function create_homepage_row_3_type() {
$homepageRow3labels = array (
//BEGIN - Việt Hóa menu custom post type
'name' => _x('Homepage row 3','Homepage row 3'),
'singular_name' => _x('Homepage row 3','Homepage row 3'),
'add_new' => __ ('Thêm row'),
...
'menu_name' => 'Homepage row 3'
//END - Việt hóa menu custom post type
);
$args = array(
'labels' => $homepageRow3labels,
...
// die;
register_post_type ('homepage_row_3',$args);
}
add_action ('init','create_homepage_row_3_type');
?>