<?php
function create_homepage_row_5_type() {
$homepageRow5labels = array (
//BEGIN - Việt Hóa menu custom post type
'name' => _x('Homepage row 5','Homepage row 5'),
'singular_name' => _x('Homepage row 5','Homepage row 5'),
'add_new' => __ ('Thêm row'),
...
'menu_name' => 'Homepage row 5'
//END - Việt hóa menu custom post type
);
$args = array(
'labels' => $homepageRow5labels,
...
// die;
register_post_type ('homepage_row_5',$args);
}
add_action ('init','create_homepage_row_5_type');
?>